...
// This is an extra class created to easily interact with the database
// with helper functions that use FlashcardDao directly.

// This class make the CRUD Operations
